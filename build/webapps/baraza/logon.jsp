...
<head>
    ...
    <title>Login | Baraza Sacco</title>
                                            ...
                                            <div class="col-inner" style="">
                                                ...
                                                <form method="POST" class="wpcf7-form form-signin" action="j_security_check" novalidate="novalidate">
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap user-name">
                                                            <a href="#" style="font-weight: 800;background-color: rgba(144, 201, 72, 1);padding: 5px;border-radius: 8px; color:#fff;">Demo Username : admin</a>
                                                            <a href="#" style="font-weight: 800;background-color: rgba(144, 201, 72, 1);padding: 5px;border-radius: 8px; color:#fff;">Member Username : member</a>
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap password">
                                                            <a href="#" style="font-weight: 800;background-color: rgba(144, 201, 72, 1);padding: 5px;border-radius: 8px; color:#fff;">Demo Admin Password : baraza</a>
                                                            <a href="#" style="font-weight: 800;background-color: rgba(144, 201, 72, 1);padding: 5px;border-radius: 8px; color:#fff;">Member Password : baraza</a>
