...
<head>
    ...
    <title>Logout | Baraza Sacco</title>
                                        ...
                                        <div class="col vc_col-sm-6 col6  col-animate-false" style="" data-effect="fade"
                                            ...
                                            <div class="col-inner" style="">
                                                ...
                                                <form action="/login/#wpcf7-f151-p143-o1" method="post"
                                                    ...
                                                    <p><h1 class="title" style="color:#8cc443;"> Baraza Sacco </h1></p><br>


                                                    <!--Error alert-->
                                                    <p class="evin-info" style="max-width: 60%;">
                                                        <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
                                                        You are now <strong>Logged out</strong>!
                                                    <p>
                                                        ...
                                                        <a href="index.jsp" class="btn-green"> Log in </a>
                                                    </p>
